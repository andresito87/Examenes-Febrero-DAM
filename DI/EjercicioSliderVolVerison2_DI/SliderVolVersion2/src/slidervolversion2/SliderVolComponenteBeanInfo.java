 ...
 * @author andres
 */
public class SliderVolComponenteBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( slidervolversion2.SliderVolComponente.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_color1 = 12;
    private static final int PROPERTY_color2 = 13;
    private static final int PROPERTY_color3 = 14;
    ...
    private static final int PROPERTY_extent = 30;
    ...
    private static final int PROPERTY_inverted = 59;
    private static final int PROPERTY_keyListeners = 60;
    private static final int PROPERTY_labelTable = 61;
    ...
    private static final int PROPERTY_orientation = 86;
    private static final int PROPERTY_paintingForPrint = 87;
    private static final int PROPERTY_paintingTile = 88;
    private static final int PROPERTY_paintLabels = 89;
    private static final int PROPERTY_paintTicks = 90;
    private static final int PROPERTY_paintTrack = 91;
    ...
    private static final int PROPERTY_rangosVolumen = 96;
    ...
    private static final int PROPERTY_snapToTicks = 102;
    private static final int PROPERTY_toolkit = 103;
    private static final int PROPERTY_toolTipText = 104;
    private static final int PROPERTY_topLevelAncestor = 105;
    private static final int PROPERTY_transferHandler = 106;
    private static final int PROPERTY_treeLock = 107;
    private static final int PROPERTY_UI = 108;
    private static final int PROPERTY_UIClassID = 109;
    private static final int PROPERTY_valid = 110;
    private static final int PROPERTY_validateRoot = 111;
    private static final int PROPERTY_value = 112;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", slidervolversion2.SliderVolComponente.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", slidervolversion2.SliderVolComponente.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", slidervolversion2.SliderVolComponente.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", slidervolversion2.SliderVolComponente.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", slidervolversion2.SliderVolComponente.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", slidervolversion2.SliderVolComponente.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", slidervolversion2.SliderVolComponente.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", slidervolversion2.SliderVolComponente.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", slidervolversion2.SliderVolComponente.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", slidervolversion2.SliderVolComponente.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", slidervolversion2.SliderVolComponente.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_changeListeners] = new PropertyDescriptor ( "changeListeners", slidervolversion2.SliderVolComponente.class, "getChangeListeners", null ); // NOI18N
            properties[PROPERTY_color1] = new PropertyDescriptor ( "color1", slidervolversion2.SliderVolComponente.class, "getColor1", "setColor1" ); // NOI18N
            properties[PROPERTY_color2] = new PropertyDescriptor ( "color2", slidervolversion2.SliderVolComponente.class, "getColor2", "setColor2" ); // NOI18N
            properties[PROPERTY_color3] = new PropertyDescriptor ( "color3", slidervolversion2.SliderVolComponente.class, "getColor3", "setColor3" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", slidervolversion2.SliderVolComponente.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", slidervolversion2.SliderVolComponente.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", slidervolversion2.SliderVolComponente.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", slidervolversion2.SliderVolComponente.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", slidervolversion2.SliderVolComponente.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", slidervolversion2.SliderVolComponente.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", slidervolversion2.SliderVolComponente.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", slidervolversion2.SliderVolComponente.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", slidervolversion2.SliderVolComponente.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", slidervolversion2.SliderVolComponente.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", slidervolversion2.SliderVolComponente.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", slidervolversion2.SliderVolComponente.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", slidervolversion2.SliderVolComponente.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", slidervolversion2.SliderVolComponente.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", slidervolversion2.SliderVolComponente.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_extent] = new PropertyDescriptor ( "extent", slidervolversion2.SliderVolComponente.class, "getExtent", "setExtent" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", slidervolversion2.SliderVolComponente.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", slidervolversion2.SliderVolComponente.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", slidervolversion2.SliderVolComponente.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", slidervolversion2.SliderVolComponente.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", slidervolversion2.SliderVolComponente.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", slidervolversion2.SliderVolComponente.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", slidervolversion2.SliderVolComponente.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", slidervolversion2.SliderVolComponente.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", slidervolversion2.SliderVolComponente.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", slidervolversion2.SliderVolComponente.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", slidervolversion2.SliderVolComponente.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", slidervolversion2.SliderVolComponente.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", slidervolversion2.SliderVolComponente.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", slidervolversion2.SliderVolComponente.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", slidervolversion2.SliderVolComponente.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", slidervolversion2.SliderVolComponente.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", slidervolversion2.SliderVolComponente.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", slidervolversion2.SliderVolComponente.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", slidervolversion2.SliderVolComponente.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", slidervolversion2.SliderVolComponente.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", slidervolversion2.SliderVolComponente.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", slidervolversion2.SliderVolComponente.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", slidervolversion2.SliderVolComponente.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", slidervolversion2.SliderVolComponente.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", slidervolversion2.SliderVolComponente.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", slidervolversion2.SliderVolComponente.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", slidervolversion2.SliderVolComponente.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", slidervolversion2.SliderVolComponente.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_inverted] = new PropertyDescriptor ( "inverted", slidervolversion2.SliderVolComponente.class, "getInverted", "setInverted" ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", slidervolversion2.SliderVolComponente.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_labelTable] = new PropertyDescriptor ( "labelTable", slidervolversion2.SliderVolComponente.class, "getLabelTable", "setLabelTable" ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", slidervolversion2.SliderVolComponente.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", slidervolversion2.SliderVolComponente.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", slidervolversion2.SliderVolComponente.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", slidervolversion2.SliderVolComponente.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", slidervolversion2.SliderVolComponente.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_majorTickSpacing] = new PropertyDescriptor ( "majorTickSpacing", slidervolversion2.SliderVolComponente.class, "getMajorTickSpacing", "setMajorTickSpacing" ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", slidervolversion2.SliderVolComponente.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximum] = new PropertyDescriptor ( "maximum", slidervolversion2.SliderVolComponente.class, "getMaximum", "setMaximum" ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", slidervolversion2.SliderVolComponente.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", slidervolversion2.SliderVolComponente.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimum] = new PropertyDescriptor ( "minimum", slidervolversion2.SliderVolComponente.class, "getMinimum", "setMinimum" ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", slidervolversion2.SliderVolComponente.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", slidervolversion2.SliderVolComponente.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_minorTickSpacing] = new PropertyDescriptor ( "minorTickSpacing", slidervolversion2.SliderVolComponente.class, "getMinorTickSpacing", "setMinorTickSpacing" ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", slidervolversion2.SliderVolComponente.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_model] = new PropertyDescriptor ( "model", slidervolversion2.SliderVolComponente.class, "getModel", "setModel" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", slidervolversion2.SliderVolComponente.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", slidervolversion2.SliderVolComponente.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", slidervolversion2.SliderVolComponente.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", slidervolversion2.SliderVolComponente.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", slidervolversion2.SliderVolComponente.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", slidervolversion2.SliderVolComponente.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", slidervolversion2.SliderVolComponente.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", slidervolversion2.SliderVolComponente.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_orientation] = new PropertyDescriptor ( "orientation", slidervolversion2.SliderVolComponente.class, "getOrientation", "setOrientation" ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", slidervolversion2.SliderVolComponente.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", slidervolversion2.SliderVolComponente.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_paintLabels] = new PropertyDescriptor ( "paintLabels", slidervolversion2.SliderVolComponente.class, "getPaintLabels", "setPaintLabels" ); // NOI18N
            properties[PROPERTY_paintTicks] = new PropertyDescriptor ( "paintTicks", slidervolversion2.SliderVolComponente.class, "getPaintTicks", "setPaintTicks" ); // NOI18N
            properties[PROPERTY_paintTrack] = new PropertyDescriptor ( "paintTrack", slidervolversion2.SliderVolComponente.class, "getPaintTrack", "setPaintTrack" ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", slidervolversion2.SliderVolComponente.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", slidervolversion2.SliderVolComponente.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", slidervolversion2.SliderVolComponente.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", slidervolversion2.SliderVolComponente.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_rangosVolumen] = new PropertyDescriptor ( "rangosVolumen", slidervolversion2.SliderVolComponente.class, "getRangosVolumen", "setRangosVolumen" ); // NOI18N
            properties[PROPERTY_rangosVolumen].setPropertyEditorClass ( slidervolversion2.SliderVolPropertyEditor.class );
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", slidervolversion2.SliderVolComponente.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", slidervolversion2.SliderVolComponente.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", slidervolversion2.SliderVolComponente.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", slidervolversion2.SliderVolComponente.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", slidervolversion2.SliderVolComponente.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_snapToTicks] = new PropertyDescriptor ( "snapToTicks", slidervolversion2.SliderVolComponente.class, "getSnapToTicks", "setSnapToTicks" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", slidervolversion2.SliderVolComponente.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", slidervolversion2.SliderVolComponente.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", slidervolversion2.SliderVolComponente.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", slidervolversion2.SliderVolComponente.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", slidervolversion2.SliderVolComponente.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", slidervolversion2.SliderVolComponente.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", slidervolversion2.SliderVolComponente.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", slidervolversion2.SliderVolComponente.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", slidervolversion2.SliderVolComponente.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_value] = new PropertyDescriptor ( "value", slidervolversion2.SliderVolComponente.class, "getValue", "setValue" ); // NOI18N
            properties[PROPERTY_valueIsAdjusting] = new PropertyDescriptor ( "valueIsAdjusting", slidervolversion2.SliderVolComponente.class, "getValueIsAdjusting", "setValueIsAdjusting" ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", slidervolversion2.SliderVolComponente.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", slidervolversion2.SliderVolComponente.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", slidervolversion2.SliderVolComponente.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", slidervolversion2.SliderVolComponente.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", slidervolversion2.SliderVolComponente.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", slidervolversion2.SliderVolComponente.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", slidervolversion2.SliderVolComponente.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_changeListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "changeListener", javax.swing.event.ChangeListener.class, new String[] {"stateChanged"}, "addChangeListener", "removeChangeListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_rangoAlcanzadoListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "rangoAlcanzadoListener", slidervolversion2.SliderVolComponente.RangoAlcanzadoListener.class, new String[] {"zonaVolumenBajoAlcanzada", "zonaVolumenMedioAlcanzada", "zonaVolumenAltoAlcanzada"}, "addRangoAlcanzadoListener", "removeRangoAlcanzadoListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( slidervolversion2.SliderVolComponente.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_createStandardLabels22 = 22;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_comprobarZona14] = new MethodDescriptor(slidervolversion2.SliderVolComponente.class.getMethod("comprobarZona", new Class[] {})); // NOI18N
            ...
            methods[METHOD_createStandardLabels21] = new MethodDescriptor(javax.swing.JSlider.class.getMethod("createStandardLabels", new Class[] {int.class})); // NOI18N
            methods[METHOD_createStandardLabels21].setDisplayName ( "" );
            methods[METHOD_createStandardLabels22] = new MethodDescriptor(javax.swing.JSlider.class.getMethod("createStandardLabels", new Class[] {int.class, int.class})); // NOI18N
            methods[METHOD_createStandardLabels22].setDisplayName ( "" );
            ...
            methods[METHOD_imageUpdate68] = new MethodDescriptor(javax.swing.JSlider.class.getMethod("imageUpdate", new Class[] {java.awt.Image.class, int.class, int.class, int.class, int.class, int.class})); // NOI18N
            ...
            methods[METHOD_updateUI146] = new MethodDescriptor(javax.swing.JSlider.class.getMethod("updateUI", new Class[] {})); // NOI18N
